...
async def get_local_evidence_snapshot(
    ...
    """
    return await GeospatialEngine.evaluate_local_signals_async(
        db=db,
        lat=latitude,
        lon=longitude,
        radius_km=radius_km,
...
async def get_nearby_msmes(
    ...
    return GeospatialEngine.get_nearby_msmes(
        lat=latitude,
        lon=longitude,
        radius_km=radius_km,
        category=category
...
async def get_nearby_pois(
    ...
    return await GeospatialEngine.get_nearby_pois_postgis(
        db=db,
        lat=latitude,
        lon=longitude,
        radius_km=radius_km,
